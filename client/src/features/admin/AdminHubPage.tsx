...
import { AlertCircle, Map, ClipboardList, BookOpen, Settings, Users, Trophy, Link2, CalendarRange, ListChecks, UsersRound, Shuffle, ScrollText, Landmark, Dices } from 'lucide-react';
