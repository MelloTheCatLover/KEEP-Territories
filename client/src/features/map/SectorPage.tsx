      ...
      {submission && (
        <Card>
          <div className="flex items-center gap-2 text-xs text-neutral-700 mb-3">
            ...
            <span>
              Действие: <b className="text-neutral-1000">{ACTION_LABELS[submission.action_type] ?? submission.action_type}</b>
              {' '}· статус{' '}
              <span className="text-neutral-1000">{submission.status}</span>
            </span>
          </div>
